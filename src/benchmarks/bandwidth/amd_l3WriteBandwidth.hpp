...
namespace benchmark {
    namespace amd {
         ...
         * @param allocType   Memory allocator for the destination buffer (default: HipMalloc).
         ...
         * @param cpuInit     Touch the destination buffer from the CPU before GPU access.
